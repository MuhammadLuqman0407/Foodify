...
const ReelFood = ({items = [],onLike,onSave,emptyMessage = 'No videos yet...'}) => {
    ...
    return(
        <div className="reels-page">
            <div className="reels-feed" role="list">
                ...
                {items.map((item)=>(
                    <sectio key = {item._id} className="reel" role="listitem">
                        <video 
                            ...
                            <div className="reel-overlay-gradient" aria-hidden="true">
                                <div className="reel-actions">
                                    ...
                                    <div className="reel-action-group">
                                        ...
                                        <div className="reel-action__count">{item.commentsCount ?? (Array.isArray(item.commets)? item.comments.length : 0)}</div>
                                    </div>
                                </div>
