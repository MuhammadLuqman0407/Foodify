...
const FoodPartnerRegister = () => {
    ...
    const handleSubmit =  (e) => {
        ...
        .catch(error => {
            console.log(" Error registrating in food partner", error);
        })
    }
  return (
        ...
        <form className='auth-form' onSubmit={handleSubmit} noValidate>
            ...
            <div className="two-col">
                <div className="field-group">
                    ...
                    <input id="contactName" name="contactName" placeholder="Muhammad Ali" autoComplete="name" />
                </div>
                <div className="field-group">
                    <label htmlFor="phone">Phone</label>
                    <input id="phone" name="phone" placeholder="+92 355 1234567" autoComplete="tel" />
                </div>
            </div>
             <div className="field-group">
